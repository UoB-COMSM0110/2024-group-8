class MapSelection extends Display {
    ...
    void setup(){
      ...
      handleMapSelection(brain, WIDTH/6, HEIGHT/5 + 50, outlineSize, GameState.BRAIN, brainMap);
      ...
      handleMapSelection(kidney, WIDTH/3 + 250, HEIGHT/5 + 350, outlineSize, GameState.KIDNEY, kidneyMap);
    ...
    void handleMapSelection(PImage mapImage, int x, int y, int outlineSize, GameState state, GameMap map){
