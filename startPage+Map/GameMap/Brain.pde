class Brain extends Map{
  PImage background_brain;
  ...
  Brain() {
    ...
    try {
      background_brain = loadImage("brain.png");
      background_brain.resize(WIDTH, HEIGHT);
  ...
  void draw() {
    image(background_brain, 0, 0, width, playWindowHeight);
