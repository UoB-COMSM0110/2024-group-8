class Heart extends Map{
  PImage background_heart;
  ...
  Heart() {
    ...
    try {
      background_heart = loadImage("heart.png");
      background_heart.resize(WIDTH, HEIGHT);
  ...
  void draw() {
    image(background_heart, 0, 0, width, playWindowHeight);
