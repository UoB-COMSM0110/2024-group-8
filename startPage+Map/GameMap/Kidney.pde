class Kidney extends Map{
  PImage background_kidney;
  ...
  Kidney() {
    ...
    try {
      background_kidney = loadImage("kidney.png");
      background_kidney.resize(WIDTH, HEIGHT);
  ...
  void draw() {
    image(background_kidney, 0, 0, width, playWindowHeight);
